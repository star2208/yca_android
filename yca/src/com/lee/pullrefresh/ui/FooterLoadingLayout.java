...
public class FooterLoadingLayout extends LoadingLayout {
	...
	@Override
	protected void setSearchCount(int count ,boolean isSearchView) {
		// TODO Auto-generated method stub
        if (isSearchView) {
            if (count == 0) {
            	mHintView.setText("未找到相关宝贝，去“推荐”看看吧！");
    		}
            else if (count < 10) {
            	mHintView.setText("只找到这些符合要求的宝贝哦，去“推荐”看看吧！");
    		}
            else {
            	mHintView.setText("如果还没找到你喜欢的宝贝，去“推荐”看看吧！");
			}
        }
	}
}
